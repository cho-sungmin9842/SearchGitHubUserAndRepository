...
public final class ItemUserBinding implements ViewBinding {
  ...
  private ItemUserBinding(@NonNull ConstraintLayout rootView, @NonNull TextView usernameTextView) {
  ...
  public static ItemUserBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemUserBinding((ConstraintLayout) rootView, usernameTextView);
    }
